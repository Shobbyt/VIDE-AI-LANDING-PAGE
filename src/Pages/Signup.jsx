      ...
      <div className="mx-auto flex min-h-[calc(100vh-7rem)] max-w-7xl items-center">
        ...
        <div className="flex w-full justify-center lg:w-1/2">
          ...
          <motion.section
            ...
            className="w-full max-w-md rounded-2xl border border-black/10 bg-white px-7 py-7 shadow-xl sm:px-9"
          >
            ...
            <div className="w-full">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="mt-5 flex w-full items-center justify-center gap-3 rounded-lg border border-black/10 bg-white px-4 py-3 text-sm font-medium text-black transition">
                <FcGoogle size={20} />
