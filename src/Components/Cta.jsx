    ...
    <section id="study-mode" className="px-6 py-20 sm:py-24">
      <motion.div
        ...
        <motion.p
          ...
          Create an account and start with the tutor mode that suits how youlearn.
        </motion.p>
        ...
        <motion.button
          ...
          className="mt-8 rounded-lg bg-[var(--color-primary)] px-6 py-3.5 font-medium text-white transition-colors hover:bg-[var(--color-primary-hover)]"  >
