            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-5">
                {features.map((feature) => {
                    ...
                    return (
                        <div
                            key={feature.title}
                            className="mx-3 flex w-auto items-center gap-5 rounded-2xl bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg sm:mx-0 lg:mx-0 lg:block border border-black/10">
